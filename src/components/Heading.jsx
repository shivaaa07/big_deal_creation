      ...
      <div className="heading">
        <div className="headingWrapper flex justify-between items-center">
          ...
          <div className="viewMoreProduct">
            <NavLink to="About" className={`flex items-center gap-1 ${viewBtn}`}>View More <MdArrowRightAlt /> </NavLink>
          </div>
        </div>
        <div className="divider w-full h-0.5 bg-indigo-100 mt-2 mb-5"></div>
      </div>
    </div>
  );
};
